...
# -*- coding: utf-8 -*-
#
# AlQorithms documentation build configuration file
#
...
#
# flake8: noqa
from hqsbase import __version__
import os
import sys
try:
    with open('../hqsbase/__version__.py') as f:
        lines = f.readlines()
...
autodoc_mock_imports = ['calculatorqore']
...
latex_documents = [
    (master_doc, 'HQSBase.tex', 'HQSBase Documentation',
...
man_pages = [
    (master_doc, 'HQSBase', 'HQSBase Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HQSBase', 'HQSBase Documentation',
     author, 'HQSBase', 'One line description of project.',
     'Miscellaneous'),
]
